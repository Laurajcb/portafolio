    ...
    <>
      <section className='container-aboutMe-section'>
        ...
        <div className='aboutMe-div-container'>
          ...
          first Python tutorial video. Since then. Front-end web development calls to all my passions; it incorporates creativity and problem solving and I'm allowed to break it to improve the code 
          (in a separate Git branch, of course). I love applying responsive design principles and watching my web pages shrink into mobile screens and still look amazing. It's oddly satisfying. I think I'm like those web pages; I'm moldable, but I still keep my creative flare intact.
          </p>
        </div>
      </section>
    </>
